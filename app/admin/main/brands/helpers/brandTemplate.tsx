...
export default function BrandTemplate ({item, className}: Props){
    ...
    return (
        <div onClick={() => router.push(`/admin/main/brands/edit/${item._id}`)} className={clsx(`w-full bg-white hover:bg-[#eeeeee] transition flex gap-[2%] py-2 px-2 cursor-grab active:cursor-grabbing`, className)}>
