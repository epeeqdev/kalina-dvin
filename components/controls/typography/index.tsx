...
type FontSize = 'text-xs' | 'text-sm' | 'text-md' | 'text-lg' | 'text-xl' | 'text-base' | 'text-small' | 'text-medium';
...
type TextPros = Props
export const Typography = ({color = 'text-secondary', fontSize = 'text-sm', fontWeight = 'font-normal', lineHeight = 'leading-6', className, title}: TextPros) => {
    return(
